            ...
            for (index in 0 until length()) {
                ...
                add(
                    CabinetReferenceSummary(
                        ...
                        documentType = item.optString("document_type"),
                        relatedParty = item.optString("related_party"),
                        documentDate = item.optString("document_date"),
                        dueDate = item.optString("due_date"),
                        emailSubject = item.optString("email_subject"),
                        emailSender = item.optString("email_sender"),
                        emailReceivedAt = item.optString("email_received_at"),
                        emailAccount = item.optString("email_account"),
