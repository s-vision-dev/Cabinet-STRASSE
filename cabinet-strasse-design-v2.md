...
|パッケージ名|`jp.viastrasse.cabinetstrasse`|
|コンセプト名|The Cabinet|
...
```text
strasse://cabinet/open/{itemId}
strasse://cabinet/collection/{collectionId}
strasse://cabinet/search?q=...
strasse://cabinet/inbox
strasse://cabinet/add
strasse://cabinet/version/add/{documentId}
```
